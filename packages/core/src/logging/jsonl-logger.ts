...
export type InteractionLogEntry = {
  ...
  durationMs: number
  error?: string
  /** Az előszűrés (request-classifier) eredménye — katalógus- vagy tudásbázis-szándék, exportot kért-e. */
  classification?: { intent: 'catalog' | 'knowledge_base'; wantsFileExport: boolean }
}
