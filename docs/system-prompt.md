...
> **Megjegyzés (2026-07-24):** a `web_search` tool kikerült ebből a promptból/toolsetből — a `web_search` mostantól kizárólag a "Plant Care Knowledge Base" tudásbázis-ág fallback-lépéseként létezik (`web-fallback-agent.ts`), nem ennek az agentnek a toolja. Lásd `docs/ddd/model.md`.
